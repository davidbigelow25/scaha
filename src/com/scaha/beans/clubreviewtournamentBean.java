...
@ManagedBean
@ViewScoped
public class clubreviewtournamentBean implements Serializable, MailableObject {
    ...
    public clubreviewtournamentBean() {  
    ...
    public String getTextBody() {
		...
		result = Utils.mergeTokens(clubreviewtournamentBean.mail_tournament_body,myTokens);
	...
	public void getTournamentsForClub() {  
		List<Tournament> templist = new ArrayList<Tournament>();
		ScahaDatabase db = (ScahaDatabase) ContextManager.getDatabase("ScahaDatabase");
    	
    	try{
    		//first get team name
    		CallableStatement cs = db.prepareCall("CALL scaha.getTournamentsforClub(?)");
