...
@ManagedBean(name="failedloiBean")
@ViewScoped
public class failedloiBean implements Serializable {
    ...
    public void failedloiDisplay(){
    	...
    	try{
			...
			CallableStatement cs = db.prepareCall("CALL scaha.getFailedLois()");
			...
			while (rs.next()) {
				...
				String sloitype = rs.getString("loitype");
				String scurrentclub = rs.getString("currentclub");
				String scurrentteam = rs.getString("currentteam");
				String spriorclub = rs.getString("priorclub");
				String spriorteam = rs.getString("priorteam");
				String sfailreason = rs.getString("failreason");
				String syear = rs.getString("scahayear");
				
				Player oplayer = new Player();
				oplayer.setIdplayer(idplayer);
				oplayer.setFirstname(sfirstname);
				oplayer.setLastname(slastname);
				oplayer.setPlayerup(sloitype);
				oplayer.setCurrentteam(scurrentteam);
				oplayer.setDob(scurrentclub);
				oplayer.setPreviousteam(spriorteam);
				oplayer.setCitizenship(spriorclub);
				oplayer.setEligibility(syear);
				oplayer.setLoidate(sfailreason);
    		...
    		LOGGER.info("ERROR IN Searching FOR failed loi's");
    		e.printStackTrace();
			db.free();
    	} finally {
