...
public class LiveGameRosterSpotList extends ListDataModel<LiveGameRosterSpot> implements Serializable, SelectableDataModel<LiveGameRosterSpot> {
	...
	public static LiveGameRosterSpotList NewListFactoryCoach(Profile _pro, ScahaDatabase _db, LiveGame _lg, TeamList _tl, String _strHomeAway) throws SQLException {
		List<LiveGameRosterSpot> data = new ArrayList<LiveGameRosterSpot>();
		HashMap<String, LiveGameRosterSpot> hm = new HashMap<String,LiveGameRosterSpot>();
		PreparedStatement ps = _db.prepareStatement("call scaha.getLiveGameCoachRosterSpots(?,?)");
		//
		// Do we have a live game?
		//
		if (_lg == null) return new LiveGameRosterSpotList(data,hm);
	...
	public static LiveGameRosterSpotList NewListFactoryByTeamid(Profile _pro, ScahaDatabase _db, Integer teamid) throws SQLException {
		List<LiveGameRosterSpot> data = new ArrayList<LiveGameRosterSpot>();
		HashMap<String, LiveGameRosterSpot> hm = new HashMap<String,LiveGameRosterSpot>();
		PreparedStatement ps = _db.prepareStatement("call scaha.getDefaultCoachRosterSpotsByTeamid(?)");
	...
	public static LiveGameRosterSpotList NewListFactoryCoachForTeam(Profile _pro, ScahaDatabase _db, Integer teamid) throws SQLException {
		List<LiveGameRosterSpot> data = new ArrayList<LiveGameRosterSpot>();
		HashMap<String, LiveGameRosterSpot> hm = new HashMap<String,LiveGameRosterSpot>();
		PreparedStatement ps = _db.prepareStatement("call scaha.getLiveGameCoachRosterSpots(?)");
